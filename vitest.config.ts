...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@nextshift/business-command-center-v1': fileURLToPath(new URL('./packages/domain/src/business-command-center-v1/business-command-center-v1.ts', import.meta.url)),
    },
  },
  test: {
    environment: 'node',
