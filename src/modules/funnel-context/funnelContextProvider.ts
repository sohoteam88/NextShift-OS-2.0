...
import type { FunnelType, FunnelContext, FunnelContextMap } from './types';

const DEFAULT_CONTEXTS: Record<FunnelType, Omit<FunnelContext, 'brandDNA'>> = {
  retail: {
 ...
 */
export async function getFunnelContext(userId: string, funnelType: FunnelType): Promise<FunnelContext | null> {
