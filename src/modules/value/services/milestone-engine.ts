...
const TEAM_MILESTONES: MilestoneDefinition[] = [
  ...
  { id: 'first_recruit', label: 'First Recruit', route: '/team', achievedAt: (facts) => facts.firstTeamMemberAt },
  { id: 'first_team_member', label: 'First Team Member', route: '/team', achievedAt: (facts) => facts.firstTeamMemberAt },
];
