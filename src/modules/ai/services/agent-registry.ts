...
export const AGENT_REGISTRY: Record<AgentId, AgentDefinition> = {
  ...
  funnel_architect: { id: 'funnel_architect', name: '漏斗架构师', description: '设计引流资源、领取页和完整转化漏斗', capabilities: ['引流资源', '线上讲座', '领取页', '漏斗优化'], allowedActions: ['build_lead_magnet', 'design_webinar', 'optimize_funnel'], requiredFeatures: ['lead_magnet', 'funnel_builder'], requiredPlan: 'pro', dependencies: ['content_director'], emoji: '🚀' },
  ...
  sales_coach: { id: 'sales_coach', name: '销售教练', description: '优化客户回复、异议处理和跟进策略', capabilities: ['智能回复', '异议处理', '跟进策略', '成交支持'], allowedActions: ['generate_reply', 'handle_objection', 'plan_followup'], requiredFeatures: ['whatsapp_ai'], requiredPlan: 'pro', dependencies: ['traffic_strategist'], emoji: '💬' },
  crm_manager: { id: 'crm_manager', name: 'CRM经理', description: '管理潜在客户优先级、管道和收入预测', capabilities: ['客户优先级', '管道管理', '收入预测', '跟进提醒'], allowedActions: ['prioritize_leads', 'review_pipeline', 'forecast_revenue'], requiredFeatures: ['crm', 'analytics'], requiredPlan: 'agency', dependencies: ['sales_coach'], emoji: '📊' },
