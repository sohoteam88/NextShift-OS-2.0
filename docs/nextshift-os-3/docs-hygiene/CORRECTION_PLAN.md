...
| --- | ---: | --- |
| Markdown files scanned | 1118 | Keep audit script as repeatable inventory |
...
| Historical files preserving old Engineering Playbook baselines | 139 | Preserve; do not bulk replace |
| Duplicate title groups with multiple versions | 11 | Classify into evolution chain vs true duplicate |
| Duplicate filename groups with multiple versions | 10 | Review generic names; avoid false positives for skills/checklists |
