      ...
      <section className="rounded-[var(--radius-lg)] border-2 border-blue-200 bg-gradient-to-b from-blue-50 to-white p-6 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-2">
            ...
            <button
              onClick={() => router.push('/ai?tab=content&platform=facebook')}
        ...
        <section className="rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-white p-5 shadow-sm">
          ...
          <div className="space-y-2">
            {AI_RECOMMENDATIONS.map((rec, i) => (
              <div key={i} className="flex items-center justify-between rounded-[var(--radius-md)] border border-[var(--color-border)] p-3 hover:bg-[var(--color-surface)] cursor-pointer" onClick={() => router.push('/ai?tab=content')}>
                <div>
