...
import type { FunnelProgress } from '../types/funnel-os';

const FUNNEL_STAGES: Record<BusinessFunnelType, string[]> = {
...
export const funnelProgressService = {
  async getProgress(userId: string, tenantId: string, funnelType: BusinessFunnelType): Promise<FunnelProgress> {
