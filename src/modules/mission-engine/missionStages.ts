...
export const BEGINNER_STAGES: MissionStage[] = [
  ...
  },
  {
    ...
    description: 'Set up your Facebook Page and Instagram professional account with AI-guided instructions.',
    whyItMatters: 'Social media is your digital storefront. Having professional-looking accounts builds trust before anyone even talks to you.',
    estimatedMinutes: 20,
  ...
  {
    id: 'first_bio',
    title: 'Your First Bio',
    description: 'Generate a professional bio for each platform that tells your story in seconds.',
