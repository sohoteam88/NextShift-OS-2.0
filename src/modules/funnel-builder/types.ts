export type FunnelType = 'lead_magnet' | 'webinar' | 'whatsapp' | 'consultation' | 'challenge';
export type FunnelStatus = 'draft' | 'ready' | 'launched' | 'optimizing';

export interface FunnelPackage {
  id: string; funnelType: FunnelType; title: string;
...
export const FUNNEL_TYPES: Record<FunnelType, { label: string; useCase: string; assets: string; action: string; cta: string }> = {
