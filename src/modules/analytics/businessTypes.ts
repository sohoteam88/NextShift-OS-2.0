...
export interface AnalyticsCenter { health: BusinessHealthScore; kpi: KPIOverview; insights: AIInsight[]; actions: NextBestAction[]; anomalies: Anomaly[]; benchmark: Benchmark; contentBreakdown: Record<string,number>; funnelMetrics: { views: number; conversions: number; rate: number }; }
