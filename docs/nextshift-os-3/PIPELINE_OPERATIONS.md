...
Blueprint 任务表 + `USER_SHELL_REBUILD_BATCH1_WORKORDERS_V1.md`(W1-W5) + `USER_SHELL_PERFORMANCE_WORKORDER_V1.md`(P1) + `SA1_RESET_TRANSACTION_TIMEOUT_WORKORDER_V1.md`(SA1/F-38)。调度裁决以 Fable 最新指令为准,记录落仓。
