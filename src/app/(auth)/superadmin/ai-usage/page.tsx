...
export default async function SuperadminAIModelUsagePage() {
      ...
      <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 space-y-2">
            {[
              { href: '/superadmin/health', label: t('systemHealth'), icon: LineChart },
              { href: '/superadmin/tenants', label: t('reviewTenantUsage'), icon: BarChart3 },
