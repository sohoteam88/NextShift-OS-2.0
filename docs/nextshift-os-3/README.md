...
NextShift OS 3.0 defines the next-generation foundation for an AI Guided Business Operating System.

The 3.0 documentation is organized by governance phase. Each later phase must align with the documents that came before it.
...
Phase 0 defines the immutable foundation of NextShift OS 3.0.

Every architecture decision, AI behavior, feature, API, database schema, and user experience must align with these documents.

If any future implementation conflicts with Phase 0, Phase 0 takes precedence.

Foundation documents:

- [0.1 First Principles](phase-0-foundation/0.1_FIRST_PRINCIPLES.md)
- [0.2 Business Ontology](phase-0-foundation/0.2_BUSINESS_ONTOLOGY.md)
- [0.3 AI Operating Loop](phase-0-foundation/0.3_AI_OPERATING_LOOP.md)
- [0.4 Business Twin Definition](phase-0-foundation/0.4_BUSINESS_TWIN_DEFINITION.md)
- [0.5 Architecture Principles](phase-0-foundation/0.5_ARCHITECTURE_PRINCIPLES.md)
- [0.6 AI Reasoning Model](phase-0-foundation/0.6_AI_REASONING_MODEL.md)
- [0.7 Business Intelligence Model](phase-0-foundation/0.7_BUSINESS_INTELLIGENCE_MODEL.md)
- [0.8 Product Philosophy](phase-0-foundation/0.8_PRODUCT_PHILOSOPHY.md)
- [0.9 Decision Intelligence Model](phase-0-foundation/0.9_DECISION_INTELLIGENCE_MODEL.md)

## Governance Rules

1. Architecture follows principles. Never the opposite.
2. Capabilities exist to support better business decisions. They never become the product themselves.
3. Every AI action must strengthen the Business Twin.
4. Every execution must generate learning.
...
- [AI Charter](constitution/AI_CHARTER.md)
- [AI Principles](constitution/AI_PRINCIPLES.md)
- [Phase 1 Constitution](phase-1-constitution/README.md)
...
- [Business Brain Architecture](phase-2-architecture/BUSINESS_BRAIN_ARCHITECTURE.md)
...
- [Event Architecture](phase-2-architecture/EVENT_ARCHITECTURE.md)
- [Cognitive Architecture](phase-2-architecture/COGNITIVE_ARCHITECTURE.md)
- [Business Twin Contract](phase-2-architecture/BUSINESS_TWIN_CONTRACT.md)
- [Story Vault Contract](phase-2-architecture/STORY_VAULT_CONTRACT.md)
- [Knowledge Graph Contract](phase-2-architecture/KNOWLEDGE_GRAPH_CONTRACT.md)
- [Business Memory Contract](phase-2-architecture/BUSINESS_MEMORY_CONTRACT.md)
...
- [Phase 3 Implementation](phase-3-implementation/README.md)
- [Sprints](sprints/README.md)
- [Sprint 000 - Blueprint Cleanup](sprints/SPRINT-000_BLUEPRINT_CLEANUP.md)
