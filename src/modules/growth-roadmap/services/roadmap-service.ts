...
const STEPS: Omit<RoadmapStep, 'status'>[] = [
  ...
  { id: 'team_building', stepNumber: 12, title: '团队建设', description: '引入你的第一个团队成员。', missionId: 'team_scaling', route: '/ai-workforce', estimatedTime: '60 分钟', rewards: ['团队成长', '授权分工'] },
  { id: 'leadership', stepNumber: 13, title: '领导力', description: '发展领导能力。', missionId: 'team_scaling', route: '/ai-workforce', estimatedTime: '持续进行', rewards: ['领导技能', '导师能力'] },
