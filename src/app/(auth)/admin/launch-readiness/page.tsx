...
export default function LaunchReadinessPage() {
  const env = useQuery({ queryKey: ['system-health'], queryFn: async () => { const r = await fetch('/api/v1/admin/system-health'); return r.json() as Promise<{ data: { checks: Record<string,boolean>; score: number; healthy: boolean; missing: string[] } }>; } });
