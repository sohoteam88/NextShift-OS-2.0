...
2. **UK-004 Release Notes omits explicit version stamp.** Unlike UK-001 and UK-002 which record "released as v1.0.0 on 2026-06-30" in README.md, the UK-004 README entry records "released as v1.0.0" without a date. This is a minor documentation consistency observation. UK-005 through UK-008 also omit explicit release dates in the README Current State entries. Optional to standardise across slices.
