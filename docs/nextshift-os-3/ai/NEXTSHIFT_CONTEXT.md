...
This file complements [AI Bootstrap](AI_BOOTSTRAP.md) and [Project Status](../PROJECT_STATUS.md). It routes assistants to the current authoritative records and does not replace or duplicate the project dashboard.
...
2. Read [Project Status](../PROJECT_STATUS.md).
3. Read [Master Index](../MASTER_INDEX.md).
4. Load only required standards for the current task.
...
Use this file to start a session quickly, then defer to [Project Status](../PROJECT_STATUS.md), [AI Context Loading](AI_CONTEXT_LOADING.md), and the relevant standards for detailed state, lifecycle, and execution rules.
