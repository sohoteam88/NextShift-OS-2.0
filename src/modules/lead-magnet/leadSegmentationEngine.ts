...
const SEGMENTS: Record<LeadSegment, Omit<SegmentResult, 'leadScore'>> = {
  A: { label: '高意向 — 准备行动', nextAction: '立即发送消息并预约策略咨询', followUpStrategy: '24小时内1对1跟进，发送完整方案', priority: 1 },
  B: { label: '有兴趣 — 需要更多信息', nextAction: '发送更多案例和证明', followUpStrategy: '3天内发3条有价值的内容 + 1次跟进', priority: 2 },
  C: { label: '探索中 — 还在了解', nextAction: '发送免费内容和教育资料', followUpStrategy: '加入你的内容生态（关注+订阅），长期培养', priority: 3 },
  D: { label: '暂未准备好 — 时机未到', nextAction: '保持轻触达，不要强推', followUpStrategy: '每个月发一条有价值的内容保持联系', priority: 4 },
};
