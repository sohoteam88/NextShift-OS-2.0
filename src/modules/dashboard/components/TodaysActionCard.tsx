...
function getActionForStage(stage: MissionStage | null): DailyAction | null {
  ...
  const actions: Partial<Record<string, DailyAction>> = {
    ...
    social_setup: {
      emoji: '📱',
      title: { zh: '设置你的社交资料', en: 'Set Up Social Profile', ms: 'Sediakan Profil Sosial' },
      description: {
        zh: 'AI 会根据 Brand DNA 生成社交用户名、平台 Bio、头像和封面方向，后续内容与漏斗 CTA 会引用这里。',
        en: 'AI generates your username, platform bios, avatar, and cover direction from Brand DNA for content and funnel CTA.',
        ms: 'AI menjana nama pengguna, bio platform, avatar dan arah cover daripada DNA jenama.',
      },
    ...
    first_bio: {
      emoji: '✍️',
      title: { zh: '确认平台 Bio', en: 'Confirm Platform Bio', ms: 'Sahkan Bio Platform' },
      description: {
        zh: '检查 AI 生成的 Facebook、Instagram 和 TikTok Bio，让每个平台都讲同一个品牌故事。',
        en: 'Review the AI-generated Facebook, Instagram, and TikTok bios so every platform tells one brand story.',
        ms: 'Semak bio Facebook, Instagram dan TikTok supaya semua platform membawa kisah jenama yang sama.',
      },
      route: '/brand-builder/step/accounts',
      buttonLabel: { zh: '确认 Bio →', en: 'Confirm Bio →', ms: 'Sahkan Bio →' },
    },
    first_content: {
      emoji: '📝',
