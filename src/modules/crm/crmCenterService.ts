...
export const crmCenterService = {
  async getCommandCenter(userId: string, tenantId: string): Promise<CRMCommandCenter> {
    ...
    // Advisor
    const advisorTips = getCRMAdvisor(leads.length, hotLeads.length, followupsOverdue, pipelineStuck);
