...
export const OPERATOR_SIDEBAR: MissionSidebarItem[] = [
  ...BUILDER_SIDEBAR,
  {
    ...
    children: [
      { icon: 'Target', label_zh: '引流资源', label_en: 'Lead Magnet', label_ms: 'Magnet Lead', route: CANONICAL_ROUTES.leadMagnet },
...
export const ADVANCED_SIDEBAR: MissionSidebarItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: 'Users', label_zh: '团队成长', label_en: 'Team Growth', label_ms: 'Pertumbuhan Pasukan', route: '/ai-workforce' },
