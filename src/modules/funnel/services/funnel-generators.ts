...
import type { FunnelBuilderType, FunnelPackage, LandingPage, ThankYouPage, WhatsAppFlow, EmailMessage, AdAngle, LaunchDay } from '../types/funnel-builder';
import { FUNNEL_TYPES } from '../types/funnel-builder';

export function generateLandingPage(ctx: BrandContext, funnelType: FunnelBuilderType, lmTitle?: string, webinarTitle?: string): LandingPage {
...
export function generateFullFunnel(ctx: BrandContext, funnelType: FunnelBuilderType, lmTitle?: string, webinarTitle?: string): FunnelPackage {
