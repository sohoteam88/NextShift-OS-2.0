...
export const funnelHealthService = {
  ...
  getActivityNextAction(
    ...
    if (videoCount === 0) return { action: '生成第一支视频', expectedImpact: '+5 位潜在客户', route: '/video?view=production' };
    ...
    return { action: '生成视频内容', expectedImpact: '+5 位潜在客户', route: '/video?view=production' };
  },
};
